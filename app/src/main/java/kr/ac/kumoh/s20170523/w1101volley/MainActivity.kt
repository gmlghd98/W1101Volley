package kr.ac.kumoh.s20170523.w1101volley
...
import kr.ac.kumoh.s20170523.w1101volley.databinding.ActivityMainBinding
...
//                        Toast.LENGTH_LONG).show()
                ...
                {
                    Toast.makeText(application, it.toString(),
                        Toast.LENGTH_LONG).show()
                }
            )
            queue.add(request)
